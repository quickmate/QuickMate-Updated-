...
PHONE_API_KEY = "cf69e1889ca10d81614c72e7060e2475"  # Add your NumVerify API Key
...
KNOWN_NUMBERS = {
    ...
    # Road & Rail
    # -------------------------
    "+91107": "Railway Accident / Security / COVID-19 Helpline",
    "+91103": "Road Accident Emergency",
    "+91139": "Indian Railways Helpline",
    "+91109MV": "Motor Vehicle Accident Helpline",  # unique key banaya

    # -------------------------
    # Health
    # -------------------------
    "+91104": "AIDS Helpline",
    "+91145": "Mental Health Helpline (KIRAN)",
    "+91191": "Blood Requirement Helpline",

    # -------------------------
    # Other National Services
    # -------------------------
    "+91105": "Natural Disaster Helpline",
    "+91196": "Senior Citizens Helpline",
    "+91144": "Anti Poison Helpline",
    "+91155": "Cyber Crime Helpline",

    # Telecom Customer Care (Examples)
    "+911982": "Airtel Customer Care",
    "+919870": "Jio Customer Care",
    "+919869": "VI (Vodafone Idea) Customer Care",
    "+919866": "BSNL Customer Care",

    # Banks (Examples – Toll Free)
    "+9118004253800": "SBI Customer Care",
    "+9118001021911": "PNB Customer Care",
    "+9118001200010": "HDFC Customer Care",
    "+9118001031906": "ICICI Customer Care",

    # Custom Saved Numbers
    "+918207293071": "Ritesh Lala",
    "+917602796231": "Ratan Lala",
    "+917872726225": "Chaina Lala",
    "+918918982019": "Tapan Lala",
    "+918207206502": "Debjyoti Roy",
    "+916266764941": "Avijit Roy",
    "+917501572766": "Tanmoy Roy",
    "+919474790537": "Debnath Chowdhury",
    "+917364839738": "Champak Mandal",
    "+919547865947": "Champak Mandal",
    "+919046491842": "Debjyoti Roy",
    "+919907066997": "Irshad Rahaman",
    "+919933931855": "Irshad Rahaman",
    "+919134360975": "Masidur Rahaman",
    "+917001229233": "Ankit Majumdar",
    "+917029829669": "Alokesh Saha",
    "+918372044842": "Anshik Mandal",
    "+916295704195": "Bishal Chowdhury",
    "+918609729200": "Biswajit Sarkar",
    "+919091842532": "Debjyoti Roy",
    "+918250719183": "Debnath Chowdhury",
    "+919547562761": "Dipankar Mandal",
    "+918391843258": "Imran Sk",
    "+919800215406": "Jeet Mandal",
    "+917908298220": "Sk Mostafi",
    "+918436524719": "Pijush Ghosh",
    "+918918792386": "Pijush Ghosh",
    "+919564178344": "Pius Mandal",
    "+917029229592": "Pius Mandal",
    "+918918652700": "Raj Mandal",
    "+916297416220": "Rajkumar Singha",
    "+919641813442": "Jeet Saha",
    "+919851107861": "Sahil Sk",
    "+919932305720": "Sanku Mandal",
    "+919883045427": "Subhrojeet Goswami",
    "+918972394775": "Tanmoy Roy",
    "+918918925112": "Subhankar Mandal",
    "+917534906031": "Shivam",
    "+919289891326": "Raghu",
    "+919883880838": "Sathi Lala",
    "+919144745612": "Sujata Swarnakar",
    "+917001336723": "Anushree Mandal",
    "+919932344225": "Keya Poddar",
    "+917365883092": "Sudipta Lala",
    "+919733013491": "Sudipta Lala",
    "+917001968239": "Prakash Mandal",
    "+919126925914": "Manas Halder",
    "+918617386968": "Sameer Kumar Das",
    "+917699187278": "Pradip Sir"
}
...
async def handle_phone_info(update: Update, context: ContextTypes.DEFAULT_TYPE, waiting_msg):
    ...
    try:
        ...
        # Clean the carrier and country
        carrier = data.get("carrier") or "Unknown"
        carrier = carrier.replace("(RJIL)", "").strip()
        ...
        if city and city.strip() and city.lower() != "unknown":
        ...
        # Keep mode active so user can send next number without pressing button
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "pin_code":
        ...
        await query.message.reply_text("📝 Send Text To Translate To English.")
    elif data == "audio_download":
        user_state[user_id]["mode"] = "AUDIO_DOWNLOAD_WAIT"
        await query.message.reply_text("🎵 Send Video Link To Download Audio :")
    elif data == "phone_info":
        user_state[user_id]["mode"] = "PHONE_INFO_WAIT"
        await query.message.reply_text("📞 Please Enter Phone Number With Country Code Example : +919876543210")
    elif data == "reels_download":
        user_state[user_id]["mode"] = "REELS_DOWNLOAD_WAIT"
        await query.message.reply_text("🎬 Send Video/Reels Link To Download :")
    elif data == "gk_quiz":
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if mode == "PIN_CODE_WAIT":
            ...
            # silently delete waiting message if mode not set
...
async def send_next_joke(user_id, query):
    ...
    await query.message.reply_text(joke, reply_markup=InlineKeyboardMarkup(
        [[InlineKeyboardButton("Next Joke", callback_data="jokes")]]
    ))
...
async def send_next_quote(user_id, query):
    ...
    await query.message.reply_text(quote, reply_markup=InlineKeyboardMarkup(
        [[InlineKeyboardButton("Next Quote", callback_data="quotes")]]
    ))
...
async def send_next_fact(user_id, query):
    ...
    await query.message.reply_text(fact, reply_markup=InlineKeyboardMarkup(
        [[InlineKeyboardButton("Next Fact", callback_data="facts")]]
    ))
...
def main():
    ...
    # Check if running on Render / public URL
    if "RENDER" in os.environ:
        print("Running in webhook mode...")
        keep_alive()  # Flask server heartbeat
        app.run_webhook(
            listen="0.0.0.0",
            port=int(os.environ.get("PORT", 5000)),
            url_path=BOT_TOKEN,
            webhook_url=f"https://quickmate-new-final-1.onrender.com/{BOT_TOKEN}"
        )
    else:
